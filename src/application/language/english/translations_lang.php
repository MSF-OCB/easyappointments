...
$lang['manage_customers_hint'] = 'Manage the registered patients and view their booking history.';
...
$lang['book_advance_timeout_hint'] = 'Define the timeout (in minutes) before the patients can book or re-arrange appointments with the organization.';
$lang['timeout_minutes'] = 'Timeout (Minutes)';
$lang['about_ea_info'] = 'Easy!Appointments is a highly customizable web application that allows your patients to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar so you can use them with other services.';
...
$lang['require_captcha_hint'] = 'When enabled, the patients will have to type a random generated CAPTCHA string before booking/updating an appointment.';
...
$lang['customer_notifications_hint'] = 'Defines whether the patient will receive email notifications whenever there is a schedule change on one of his appointments.';
